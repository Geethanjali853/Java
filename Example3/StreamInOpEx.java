...
public class StreamInOpEx {
    public static void main(String[] args) {
        //List of lists of names
        List<List<String>> listofLists = Arrays.asList(Arrays.asList("Reflection", "Collection", "Stream"), Arrays.asList("Structure", "State", "Flow"), Arrays.asList("Sorting", "Mapping", "Reduction", "Stream"));
